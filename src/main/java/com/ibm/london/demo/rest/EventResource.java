package com.ibm.london.demo.rest;

import com.ibm.london.demo.dao.EventDao;
...
public class EventResource {
    ...
    @Transactional
    // end::Transactional[]
    public Response addNewEvent(@FormParam("id") int id, @FormParam("name") String name,
        @FormParam("time") String time, @FormParam("location") String location) {
        Event newEvent = new Event(id, name, location, time);
        if (eventDAO.findEvent(id) != null) {
